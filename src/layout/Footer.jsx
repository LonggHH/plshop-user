                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="footer-logo">
                                        ...
                                        <p className="info">
                                            Lipuma is the trusted destination for tech enthusiasts, offering top-quality computers and phones.
                                            With a commitment to reliability and quality, Lipuma leads the way in meeting your tech shopping needs.
                                        </p>
                                    </div>
                                    <ul className="des">
                                        <li>
                                            <span>Address: </span>
                                            141 Chien Thang Street, Tan Trieu Commune, Thanh Tri District, Ha Noi City
                                        </li>
                                        <li>
                                            <span>Phone: </span>
                                            <a>(+84) 981 055 321</a>
                                        ...
                                        <li>
                                            <span>Email: </span>
                                            <a href="mailto://info@yourdomain.com">lipuma@yourdomain.com</a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        >
                                            <div id="mc_embed_signup_scroll">
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <button className="btn" id="mc-submit" type="button">
                                                        Subscribe
                                                    </button>
                                                </div>
                                            </div>
